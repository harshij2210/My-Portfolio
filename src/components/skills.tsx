...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["React.js", "HTML5", "CSS3", "Bootstrap" , "Next.js", "Tailwind CSS"],
  ...
  },
  {
    ...
    skills: ["MongoDB", "Mongoose", "MySQL", "Sequelize ORM"],
    icon: <Database className={styles.skillIcon} />,
    gradient: "purpleViolet",
  },
  {
    title: "Tools & Technologies",
    skills: ["Git", "GitHub", "GitLab", "Postman", "Swagger", "Notion", "Figma", "Render", "Vercel"],
